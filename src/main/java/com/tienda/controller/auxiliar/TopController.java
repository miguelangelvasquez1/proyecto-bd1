...
public class TopController {
    ...
    private void createPurchase() {
        openWindow("/views/CreatePurchase.fxml", "Nueva Venta");
    }

    @FXML
    private void openSales() {
        openWindow("/views/SalesHistoryView.fxml", "Historial de Ventas");
    }
    ...
    private void openClientReport() {
        openWindow("/views/DefaulterReport.fxml", "Clientes Morosos");
    }
